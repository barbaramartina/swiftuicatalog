            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Image(systemName: "pencil.tip")
                        .resizable()
                        .rotationEffect(
                            isActive1 ? Angle(degrees: 360) : Angle(degrees: 0)
                        )
            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Image(systemName: "bonjour")
                        ...
                        .animation(
                            .easeInOut(duration: 1).repeatCount(10),
                            value: isActive3
                        )
            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    RoundedRectangle(cornerRadius: isActive6 ? 18 : 0)
                        .animation(
                            .easeIn(duration: 0.7).repeatCount(10),
                            value: isActive6
                        )
                    Spacer()
                }
            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Image(systemName: "figure.cooldown")
                        .resizable()
                        .shadow(
                            color: isActive5 ? .green : .clear,
                            radius: isActive5
                                ? /*@START_MENU_TOKEN@*/
                                10 /*@END_MENU_TOKEN@*/ : 0
                        )
                        .animation(
                            .easeInOut(duration: 1).repeatCount(5),
                            value: isActive5
                        )
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        Image(systemName: "bonjour")
                            .resizable()
                            .offset(
                                x: isActive4 ? (geometry.size.width + 80) : 0
                            )
                            .animation(
