...
struct TransitionsAnimationsView: View, Comparable {
    ...
    @State private var animate1 = false {
        didSet {
            if animate1 == true {
                resetFlags(indexes: [2, 3, 4, 5, 6, 7, 8, 9])
            }
        }
    }
    @State private var animate2 = false {
        didSet {
            if animate2 == true {
                resetFlags(indexes: [1, 3, 4, 5, 6, 7, 8, 9])
            }
        }
    }
    @State private var animate3 = false {
        didSet {
            if animate3 == true {
                resetFlags(indexes: [1, 2, 4, 5, 6, 7, 8, 9])
            }
        }
    }
    @State private var animate4 = false {
        didSet {
            if animate4 == true {
                resetFlags(indexes: [1, 2, 3, 5, 6, 7, 8, 9])
            }
        }
    }
    @State private var animate5 = false {
        didSet {
            if animate5 == true {
                resetFlags(indexes: [1, 2, 3, 4, 6, 7, 8, 9])
            }
        }
    }
    @State private var animate6 = false {
        didSet {
            if animate6 == true {
                resetFlags(indexes: [1, 2, 3, 4, 5, 7, 8, 9])
            }
        }
    }
    @State private var animate7 = false {
        didSet {
            if animate7 == true {
                resetFlags(indexes: [1, 2, 3, 4, 5, 6, 8, 9])
            }
        }
    }
    @State private var animate8 = false {
        didSet {
            if animate8 == true {
                resetFlags(indexes: [1, 2, 3, 4, 5, 6, 7, 9])
            }
        }
    }
    @State private var animate9 = false {
        didSet {
            if animate9 == true {
                resetFlags(indexes: [1, 2, 3, 4, 5, 6, 7, 8])
            }
        }
    }
